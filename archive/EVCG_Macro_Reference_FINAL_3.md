...
To accurately simulate scene flow, camera movement, and emotional beats during event CG display, the following heuristics can be applied to sequences of `[evcg]` calls and their arguments:
